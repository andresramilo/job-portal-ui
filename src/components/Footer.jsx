          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a className="group relative hover:text-white transition-colors duration-300 cursor-pointer">
                ...
                <div
                  role="tooltip"
                  className="pointer-events-none absolute bottom-full left-1/2 z-20 mb-3 w-64 -translate-x-1/2 rounded-lg bg-gray-800 p-3 text-xs leading-relaxed text-gray-200 shadow-xl ring-1 ring-gray-700 opacity-0 invisible translate-y-1 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300"
                >
                  We respect your privacy. JobPortal collects only the
                  information needed to connect you with opportunities, never
                  sells your data, and lets you manage or delete your details at
                  any time.
                  <span className="absolute left-1/2 top-full -translate-x-1/2 border-8 border-transparent border-t-gray-800"></span>
                </div>
              </a>
              <a className="group relative hover:text-white transition-colors duration-300 cursor-pointer">
              ...
              >
                ...
                <div
                  ...
                  className="pointer-events-none absolute bottom-full left-1/2 z-20 mb-3 w-64 -translate-x-1/2 rounded-lg bg-gray-800 p-3 text-xs leading-relaxed text-gray-200 shadow-xl ring-1 ring-gray-700 opacity-0 invisible translate-y-1 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300"
                >
                  Have questions or need support? Reach out to the JobPortal team — we&apos;re here to help you with anything from technical issues to career guidance.
                  <span className="absolute left-1/2 top-full -translate-x-1/2 border-8 border-transparent border-t-gray-800"></span>
                </div>
              </Link>
            </div>
